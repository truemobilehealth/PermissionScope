...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        singlePscope.addPermission(NotificationsPermission(), message: "We use this to send you\r\nspam and love notes")

        multiPscope.addPermission(ContactsPermission(), message: "We use this to steal\r\nyour friends")
        multiPscope.addPermission(NotificationsPermission(), message: "We use this to send you\r\nspam and love notes")
...
//        multiPscope.addPermission(BluetoothPermission(), message: "We use this to drain your battery")
        ...
        noUIPscope.addPermission(NotificationsPermission(), message: "notifications")
